...
public class collections {
    public static void main(String[] args) throws ArrayIndexOutOfBoundsException,InputMismatchException
    {
        ...
        depts.add("Infrastructure");

        Map<String,List<IgniteMembers>> mem = new HashMap<>();
        mem.put("DataScience",dataScience);
        ...
        do {
            ...
            if (c == 1) {
                ...
                System.out.println("\nEnter the name of the dept to be deleted");
                String dd = sc.next();

                int delDept = depts.indexOf(dd);
                ...
                System.out.println("Enter the name of the department to which the member is to be added");
                String dd = sc.next();

                int ch = depts.indexOf(dd);
