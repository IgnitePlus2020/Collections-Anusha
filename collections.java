    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if (c == 1) {
                ...
                System.out.println("Enter the name of the dept to be deleted");
                ...
                listOfDepartments[delDept].remove(0);
                ...
                int a = 0;
                System.out.println("Enter the number of the department to which the member is to be added");
                for (String dept : mem.keySet()) {
                    a++;
                    System.out.println(a + "." + dept);
                }
                ...
                set.add(s2);
                set.add(s3);
                listOfDepartments[ch-1].add(new IgniteMembers(nam, coll, ag, set));
                System.out.println("Added successfully ");
                for (IgniteMembers i : listOfDepartments[ch-1])
                    System.out.println(i.toString());
            }
            else if (c == 6)
                System.exit(0);
...
//listOfDepartments.indexOf(mem.get("Data Science"));
